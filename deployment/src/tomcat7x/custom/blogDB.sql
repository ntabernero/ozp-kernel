...
CREATE TABLE AUTHOR_COMMENT (AUTHOR_EMAIL VARCHAR(255), COMMENTS_ID BIGINT);
...
CREATE TABLE BLOGENTRY_COMMENT (BLOGENTRY_ID BIGINT, COMMENTS_ID BIGINT);
CREATE TABLE COMMENT (id BIGINT NOT NULL, commentText VARCHAR(10000), createdDate TIMESTAMP, AUTHOR_EMAIL VARCHAR(255), POST_ID BIGINT, PRIMARY KEY (id));
...
CREATE INDEX I_THR_TRY_COMMENTS_AUTHOR_EMAIL ON AUTHOR_COMMENT (AUTHOR_EMAIL);
CREATE INDEX I_THR_TRY_COMMENTS_ELEMENT ON AUTHOR_COMMENT (COMMENTS_ID);
CREATE INDEX I_THR_TRY_COMMENTS_BLOGENTRY ON BLOGENTRY_COMMENT (BLOGENTRY_ID);
CREATE INDEX I_THR_TRY_COMMENTS_BLOGENTRY_ELEMENT ON BLOGENTRY_COMMENT (COMMENTS_ID);
CREATE INDEX I_BLGNTRY_AUTHOR ON BLOGENTRY (AUTHOR_EMAIL);
DELETE FROM AUTHOR;
DELETE FROM AUTHOR_BLOGENTRY;
DELETE FROM AUTHOR_COMMENT;
DELETE FROM BLOGENTRY;
DELETE FROM BLOGENTRY_COMMENT;
DELETE FROM COMMENT;
