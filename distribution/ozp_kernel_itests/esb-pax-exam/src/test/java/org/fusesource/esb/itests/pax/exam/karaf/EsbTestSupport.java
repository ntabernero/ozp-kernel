...
public class EsbTestSupport extends FuseTestSupport {
    static final String GROUP_ID = "org.ozoneplatform.kernel.distribution";
    static final String ARTIFACT_ID = "enterprise";
    ...
    protected Option esbDistributionConfiguration() {
        return new DefaultCompositeOption(
                new Option[]{karafDistributionConfiguration().frameworkUrl(
                        ...
                        .karafVersion(getKarafVersion()).name("OzonePlatform Distro").unpackDirectory(new File("target/paxexam/unpack/")),
