...
[uninstalled] [2.5.6.SEC01] spring     karaf-${karaf.version}
[uninstalled] [1.2.0      ] spring-dm  karaf-${karaf.version}
[uninstalled] [${karaf.version}] wrapper    karaf-${karaf.version}
[uninstalled] [${karaf.version}] obr        karaf-${karaf.version}
[uninstalled] [${karaf.version}] http       karaf-${karaf.version}
[uninstalled] [${karaf.version}] webconsole karaf-${karaf.version}
[installed  ] [${karaf.version}] ssh        karaf-${karaf.version}
[installed  ] [${karaf.version}] management karaf-${karaf.version}
...
Maven builds the web application, web-${karaf.version}.war, and
